...
"${HOST_DIR}/bin/mkimage" -n rk3128 -T rksd -d "${BINARIES_DIR}/rk3128_ddr_300MHz_v2.12.bin" "${BINARIES_DIR}/idbloader.img" || exit 1
#-A arm64 -O linux -T kernel -C none -a 0x1080000 -e 0x1080000 -n 5.x -d "${BINARIES_DIR}/Image" "${BATOCERA_BINARIES_DIR}/boot/boot/linux" || exit 1
...
cp "${BINARIES_DIR}/rk3128-wx8.dtb"                 "${BATOCERA_BINARIES_DIR}/boot/boot/rk3128-wx8.dtb"                      || exit 1
